...
class CartDesktopItem extends StatefulWidget {
  ...
  @override
  State<CartDesktopItem> createState() => _CartDesktopItemState();
}

class _CartDesktopItemState extends State<CartDesktopItem> {
  @override
